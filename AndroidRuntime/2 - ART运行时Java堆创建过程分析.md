...
34.   
35.   // Requested begin for the alloc space, to follow the mapped image and oat files  
...
42.   runtime->SetCalleeSaveMethod(down_cast<mirror::ArtMethod*>(callee_save_method), Runtime::kRefsOnly);  
